...
| price | $94.55 |
| market cap | $3.2B |
| 5d / 21d / 63d / 252d | +0.7% / +1.2% / +19.7% / +57.4% |
| 60d avg daily $ volume | $72.6M |
...
Gap under that baseline: **+123.4%** (fair value $211.23 vs price $94.55).

> The baseline is the company's own revenue history mechanically applied to FCFF. It is NOT a thesis and carries no judgment — it exists only to rank candidates. Your job below is to replace it.

Cohort: **91th percentile** of 151 Industrials names priced the same way — a HIGH percentile means cheap relative to peers (gap vs cohort median: +145.8%).
